  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-xs">
        <motion.h2
          animate={desktopInView ? { y: 0, opacity: 1 } : { y: -50, opacity: 0 }}
        ...
        <motion.p
          animate={desktopInView ? { y: 0, opacity: 1 } : { y: -40, opacity: 0 }}
        ...
        <p className="text-xl font-semibold text-[#775A00] font-['Cormorant']">Dress code</p>
        <motion.p
          animate={desktopInView ? { y: 0, opacity: 1 } : { y: -40, opacity: 0 }}
          transition={{ delay: 0.4 }}
          className="text-sm font-semibold px-4 text-[#775A00] font-['Cormorant']"
        >
          Embracing the charm of Gujarati heritage Bandhani, Patola, Leheriya or
          Kutchi Mirrorwork
        </motion.p>
      </div>
    </section>
    ...
    >
      ...
      <div className="text-center max-w-xs">
        <motion.h2
          animate={mobileInView ? { y: 0, opacity: 1 } : { y: -50, opacity: 0 }}
          transition={{ duration: 0.8 }}
        ...
        <motion.p
          animate={mobileInView ? { y: 0, opacity: 1 } : { y: -40, opacity: 0 }}
          transition={{ delay: 0.2 }}
        ...
        <p className="text-lg text-[#775A00] font-['Cormorant']">Dress code</p>
        <motion.p
          animate={mobileInView ? { y: 0, opacity: 1 } : { y: -40, opacity: 0 }}
          transition={{ delay: 0.4 }}
