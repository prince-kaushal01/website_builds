...
const SHEET_URL =
  "https://script.google.com/macros/s/AKfycbz9F4CBR1nbx38q8950OE_foh0wEaH3kT4b2oZBeP1ASuMmb6gYAIdBeVZO7E7pFbeL/exec";
        ...
        <div className="relative z-10 flex flex-col items-center w-full px-8 pt-10 pb-12 gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-2 w-48 mt-2">
              ...
              <span
                className="text-[0.45rem] text-[#b8822a]"
          ...
          {status === "success" ? (
            ...
            <div className="flex flex-col items-center gap-1 text-center py-2">
              <p className="font-great-vibes text-[2rem] text-[#d4a84b] drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">
                Thank you!
              </p>
